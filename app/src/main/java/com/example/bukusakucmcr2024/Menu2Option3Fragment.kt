 ...
 */
class Menu2Option3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu2_option3, container, false)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/barangMilikNegara_perencanaanBMN_riskRegister")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        // link SOP
        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/barangMilikNegara_perencanaanBMN_SOP")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        ...
        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/barangMilikNegara_perencanaanBMN_jadwalPengendalian")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
