...
class Menu4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu4_option1, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif4_1)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif4_2)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif4_3)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif4_4)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif4_5)
...
// Memuat GIF kedua
        ...
        // Animasi warna untuk semua tombol
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/49rs1sI")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4gpkcWR")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3VZsGMk")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4kMpvkZ")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        buttons[4].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3ZLrvT4")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
