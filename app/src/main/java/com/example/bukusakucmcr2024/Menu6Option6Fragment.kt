 ...
 */
class Menu6Option6Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu6_option6, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif6_21)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif6_22)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif6_23)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif6_24)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif6_25)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/kepelatihan_prosedurBangkom_riskRegister")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        // link sop
        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/kepelatihan_prosedurBangkom_SOP")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        ...
        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/kepelatihan_prosedurBangkom_jadwalPengendalian")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment Menu6Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Menu6Option6Fragment().apply {
