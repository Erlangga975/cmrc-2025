 ...
 */
class Menu6Option5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu6_option5, container, false)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/49v6VJL")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3OHOacA")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/41WDEpU")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3Vza2dZ")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
