 ...
 */
class Menu2Option4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu2_option4, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif2_6)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif2_7)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif2_8)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif2_9)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif2_10)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/barangMilikNegara_pengamananBMN_riskRegister")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        // link SOP
        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/barangMilikNegara_pengamananBMN_SOP")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        // link bukti pengendalian
        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/barangMilikNegara_pengamananBMN_buktiPengendalian")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        // link jadwal pengendalian
        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/barangMilikNegara_pengamananBMN_jadwalPengendalian")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
