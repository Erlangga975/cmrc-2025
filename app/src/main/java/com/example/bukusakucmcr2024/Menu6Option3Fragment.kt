 ...
 */
class Menu6Option3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu6_option3, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif6_11)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif6_12)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif6_13)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif6_14)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif6_15)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4f3JKYt")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4gov5rV")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/44sUKeo")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/41lvOps")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
