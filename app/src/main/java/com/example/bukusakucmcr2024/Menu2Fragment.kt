...
class Menu2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu2_option1, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif2_1)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif2_2)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif2_3)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif2_4)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif2_5)
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4g62isa")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3BoWQBx")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4lMtaQt")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4gr3EO5")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
