 ...
 */
class Menu7Option4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu7_option4, container, false)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3WtUNDT")
        ...
        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/42kT1bF")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        ...
        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4hgidEC")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
