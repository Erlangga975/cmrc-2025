 ...
 */
class Menu6Option4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu6_option4, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif6_16)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif6_17)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif6_18)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif6_19)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif6_20)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4gnpIJf")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3ZCY8Cu")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4kwMmka")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3ZK3P1j")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
