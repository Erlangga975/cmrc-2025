 ...
 */
class Menu4Option2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu4_option2, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif4_6)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif4_7)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif4_8)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif4_9)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif4_10)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3OMDFVya")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/41nzVkK")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4gCoKcE")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
