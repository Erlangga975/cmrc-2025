 ...
 */
class Menu7Option5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu7_option5, container, false)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4gdR5Fg")
        ...
        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4jqmsz5")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        // link bukti pengendalian
        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4gaXK39")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        // link jadwal pengendalian
        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4jt5X5q")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
