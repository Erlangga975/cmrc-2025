 ...
 */
class Menu6Option2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu6_option2, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif6_6)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif6_7)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif6_8)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif6_9)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif6_10)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3DfF58h")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3DbrJKg")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3BP5gCB")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3BlKDh4")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
