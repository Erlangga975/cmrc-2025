 ...
 */
class Menu4Option3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu4_option3, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif4_11)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif4_12)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif4_13)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif4_14)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif4_15)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3D9xqIY")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4f32Uh6")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/44kyR2h")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4ishpOa")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
