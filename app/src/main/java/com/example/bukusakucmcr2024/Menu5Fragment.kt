...
class Menu5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu5_option1, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif5_1)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif5_2)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif5_3)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif5_4)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif5_5)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4ir0JGU")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4ikTMXT")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3BM65fx")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4f6jXi5")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment Menu5Fragment.
         */
