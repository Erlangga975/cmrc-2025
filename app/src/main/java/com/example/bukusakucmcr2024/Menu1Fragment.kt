...
class Menu1Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu1_option1, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif1)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif2)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif3)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif4)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif5)
...
// Memuat GIF kedua
        ...
        val buttons = listOf(
            ...
            view.findViewById<Button>(R.id.my_button),
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4gIRccP")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3OHkKvb")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/3Pm9rZy")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/41tj0gU")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
