 ...
 */
class Menu3Option2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu3_option2, container, false)

        val imageViewGif1 = view.findViewById<ImageView>(R.id.imageViewGif3_1)
        val imageViewGif2 = view.findViewById<ImageView>(R.id.imageViewGif3_2)
        val imageViewGif3 = view.findViewById<ImageView>(R.id.imageViewGif3_3)
        val imageViewGif4 = view.findViewById<ImageView>(R.id.imageViewGif3_4)
        val imageViewGif5 = view.findViewById<ImageView>(R.id.imageViewGif3_5)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/kepagawaian_administrasiKehadiran_riskRegister")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        // link SOP
        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/kepagawaian_administrasiKehadiran_SOP")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        // link bukti pengendalian
        buttons[2].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/kepagawaian_administrasiKehadiran_buktiPengendalian")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
        // link jadwal pengendalian
        buttons[3].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/kepagawaian_administrasiKehadiran_jadlwaPengendalian")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
