 ...
 */
class Menu7Option3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.menu7_option3, container, false)
...
// Memuat GIF kedua
        ...
        buttons[0].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4jqixCn")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }

        // link sop
        buttons[1].setOnClickListener {
            val uri = Uri.parse("https://bit.ly/4jttEdR")
            startActivity(Intent(Intent.ACTION_VIEW, uri))
        }
